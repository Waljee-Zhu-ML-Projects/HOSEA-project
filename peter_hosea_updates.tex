...
\begin{itemize}
	...
	\begin{description}
		...
		\item[resample] sample (w/ replacement) the controls up to the number of controls (note that controls appearing more than once get different imputation)
		\item[unweighted] no resample, no rewighing
...
\begin{itemize}
	...
	\item Parameters:
		\begin{description}
			...
			\item[subsample] Determines what percetage of the training set is used to fit the next tree (more subsampling prevents overfitting but slows down fitting)
