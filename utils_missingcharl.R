...
charl_checks <- list(
  'chf'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,6)=='398.91',
                     substr(s,1,6)=='402.01',
                     substr(s,1,6)=='402.11',
                     substr(s,1,6)=='402.91',
                     substr(s,1,6)=='404.01',
    ...
    'icd10'=function(s){
      as.integer(any(substr(s,1,5)=='I09.9',
                     substr(s,1,5)=='I11.0',
                     substr(s,1,5)=='I13.0',
                     substr(s,1,5)=='I13.2',
                     substr(s,1,5)=='I25.5',
  ...
  'ctd'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,5)=='446.5',
                     substr(s,1,5)=='710.0',
                     substr(s,1,5)=='710.1',
                     substr(s,1,5)=='710.2',
                     substr(s,1,5)=='710.3',
    ...
    'icd10'=function(s){
      as.integer(any(substr(s,1,3)=='M05',
                     substr(s,1,3)=='M06',
                     substr(s,1,5)=='M31.5',
                     substr(s,1,5)=='M35.1',
                     substr(s,1,5)=='M35.3',
  ...
  'dem'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,4)=='290.',
                     substr(s,1,5)=='294.1',
                     substr(s,1,5)=='331.2'))
    },
    'icd10'=function(s){
      as.integer(any(substr(s,1,3)=='F00',
                     substr(s,1,3)=='F01',
                     substr(s,1,3)=='F02',
                     substr(s,1,3)=='F03',
                     substr(s,1,5)=='F05.1',
  ...
  'diab_c'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,5)=='250.4',
                     substr(s,1,5)=='250.5',
                     substr(s,1,5)=='250.6',
                     substr(s,1,5)=='250.7'))
    },
  ...
  'gerd'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,6)=='530.11',
                     substr(s,1,6)=='530.81'))
    },
    'icd10'=function(s){
  ...
  'hiv'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,4)=='042.',
                     substr(s,1,4)=='043.',
                     substr(s,1,4)=='044.'))
    },
    'icd10'=function(s){
      as.integer(any(substr(s,1,3)=='B20',
                     substr(s,1,3)=='B21',
                     substr(s,1,3)=='B22',
                     substr(s,1,3)=='B24'))
      }),
  'mld'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,6)=='070.22',
                     substr(s,1,6)=='070.23',
                     substr(s,1,6)=='070.32',
                     substr(s,1,6)=='070.33',
                     substr(s,1,6)=='070.44',
    ...
    'icd10'=function(s){
      as.integer(any(substr(s,1,3)=='B18',
                     substr(s,1,5)=='K70.0',
                     substr(s,1,5)=='K70.1',
                     substr(s,1,5)=='K70.2',
                     substr(s,1,5)=='K70.3',
  ...
  'msld'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,5)=='456.0',
                     substr(s,1,5)=='456.1',
                     substr(s,1,5)=='456.2',
                     substr(s,1,5)=='572.2',
                     substr(s,1,5)=='572.3',
    ...
    'icd10'=function(s){
      as.integer(any(substr(s,1,5)=='I85.0',
                     substr(s,1,5)=='I85.9',
                     substr(s,1,5)=='I86.4',
                     substr(s,1,5)=='I98.2',
                     substr(s,1,5)=='K70.4',
  ...
  'para'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,5)=='334.1',
                     substr(s,1,4)=='342.',
                     substr(s,1,4)=='343.',
                     substr(s,1,5)=='344.0',
                     substr(s,1,5)=='344.1',
    ...
    'icd10'=function(s){
      as.integer(any(substr(s,1,5)=='G04.1',
                     substr(s,1,5)=='G11.4',
                     substr(s,1,5)=='G80.1',
                     substr(s,1,5)=='G80.2',
                     substr(s,1,3)=='G81',
  ...
  'rd'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,6)=='403.01',
                     substr(s,1,6)=='403.11',
                     substr(s,1,6)=='403.91',
                     substr(s,1,6)=='404.02',
                     substr(s,1,6)=='404.03',
    ...
    'icd10'=function(s){
      as.integer(any(substr(s,1,5) %in% paste0('N0',apply(expand.grid(c(3,5),c(2:7)),1,paste0,collapse='.')),
                     substr(s,1,5)=='I12.0',
                     substr(s,1,5)=='I13.0',
                     substr(s,1,3)=='N18',
                     substr(s,1,3)=='N19',
  ...
  'cd'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,6)=='362.34',
                     substr(s,1,4)=='430.',
                     substr(s,1,4)=='431.',
                     substr(s,1,4)=='432.',
                     substr(s,1,4)=='433.',
    ...
    'icd10'=function(s){
      as.integer(any(substr(s,1,3) %in% paste0('I6',c(0:9)),
                     substr(s,1,3)=='G45',
                     substr(s,1,3)=='G46',
                     substr(s,1,5)=='H34.0'))
    }),
  'copd'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,5)=='416.8',
                     substr(s,1,5)=='416.9',
                     substr(s,1,4)=='490.',
                     substr(s,1,4)=='491.',
                     substr(s,1,4)=='492.',
    ...
    'icd10'=function(s){
      as.integer(any(substr(s,1,3) %in% paste0('J',apply(expand.grid(c(4,6),c(0:7)),1,paste0,collapse='')),
                     substr(s,1,5)=='I27.8',
                     substr(s,1,5)=='I27.9',
                     substr(s,1,5)=='J70.1',
                     substr(s,1,5)=='J70.3'))
  ...
  'diab_nc'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,5)=='250.0',
                     substr(s,1,5)=='250.1',
                     substr(s,1,5)=='250.2',
                     substr(s,1,5)=='250.3',
                     substr(s,1,5)=='250.8',
  ...
  'mi'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,4)=='410.',
                     substr(s,1,4)=='412.'))
    },
    'icd10'=function(s){
      as.integer(any(substr(s,1,3)=='I21',
                     substr(s,1,3)=='I22',
                     substr(s,1,5)=='I25.2'))
    }),
  'pud'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,4)=='531.',
                     substr(s,1,4)=='532.',
                     substr(s,1,4)=='533.',
                     substr(s,1,4)=='534.'))
    },
    'icd10'=function(s){
      as.integer(any(substr(s,1,3)=='K25',
                     substr(s,1,3)=='K26',
                     substr(s,1,3)=='K27',
                     substr(s,1,3)=='K28'))
    }),
  'pvd'=list(
    'icd9'=function(s){
      as.integer(any(substr(s,1,5)=='093.0',
                     substr(s,1,5)=='437.3',
                     substr(s,1,4)=='440.',
                     substr(s,1,4)=='441.',
                     substr(s,1,5)=='443.1.',
    ...
    'icd10'=function(s){
      as.integer(any(substr(s,1,5)=='I73.1',
                     substr(s,1,5)=='I73.8',
                     substr(s,1,5)=='I73.9',
                     substr(s,1,5)=='I77.1',
                     substr(s,1,5)=='I79.0',
